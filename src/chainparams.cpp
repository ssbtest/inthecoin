...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (     0, uint256("0x000000df5e78a132d13360352de3feb5367639d009c603dd19dde317164870ce"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1539570459, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x000000df5e78a132d13360352de3feb5367639d009c603dd19dde317164870ce"));
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0x04a36a777b778b32608419823a6139a8dbbcd94552c24d25c508fb33f1036cdd77d30900d27fbca7d15933af696579cdfe64f8a7051589027266330b93323a9548");
        nDefaultPort = 10101;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "15 October 2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1539570459;
        genesis.nBits = 0x1e0ffff0;;
        genesis.nNonce = 138824;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000000df5e78a132d13360352de3feb5367639d009c603dd19dde317164870ce"));
        assert(genesis.hashMerkleRoot == uint256("0xe215bc90e14bfea9600cd0bbd61c9c126fbdcc91bb99889ffb7c203429b45cee"));
        ...
        strSporkKey = "040eafa76b3fe34219800950b787fa5fe75dc692a63e5f536c572f7815626f53d79321e20e6ca6b2af4aba815f6c10b4a491a15c56b7c39adbcc8057289f3ba514";
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("0x04750f0b38055ced3db99abc5890cdfac585df4e7b6b2da23c6fbd7ea27b7c257ee11cb9fd29f432ed169bc57cab8f005f4862efa58bf2ffd0f3c8f06547648a6e");
        nDefaultPort = 10103;
        ...
        genesis.nTime = 1539570523;
        genesis.nNonce = 1083822;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000ba79f9c95b0652dff2840213dfb97d763c3d6a9a503f93742b3d06fa838"));
        ...
        strSporkKey = "04906715444bcc820d0e32545d506f7929b125b3e869777ed92bda30766ea97dd28b6ef82c39cfa06abac2e3dbb5ec4cf3eede65cca1305f9f9fe4222a8db79390";
        strObfuscationPoolDummyAddress = "PCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp";
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 10103;
        assert(hashGenesisBlock == uint256("0x3bb40764fab308ff336482ccf188d22ff7cae885913161c482b37b1729ef8cff"));
